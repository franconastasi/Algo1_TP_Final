...
status_t generarMensajes(size_t n, lista_t *l, sensor_t **sens, size_t);
status_t procesarMensajes(size_t m, lista_t *l);
status_t procesarMensajeBIN(mensaje_t *l, FILE *fp);
status_t procesarMensajeCSV(mensaje_t *l, FILE *fp);
...
int obtener_pos(char *elem, int n_max_elem, const char *str_array[]);
